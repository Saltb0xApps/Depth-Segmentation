...
//
//  Created by Akhil Tolani.
//  Copyright © 2020 Akhil Tolani. All rights reserved.
//
...
class RealtimeDepthMaskViewController: UIViewController {
    ...
    private let serialQueue = DispatchQueue(label: "com.akhil.depth-example.queue")
    ...
    override func viewDidLoad() {
        ...
        let filename = String(format: "black")
